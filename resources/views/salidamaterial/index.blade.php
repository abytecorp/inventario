...
<section id="content_section" class="content">
  <p><a href="http://lineadfuego.com.co/inventario/admin/salida_orden_material"><i class="fa fa-chevron-circle-left"></i> &nbsp; Volver al  listado Materiales</a></p>
...
$(document).ready(function(){
  ...
  function iniciarTodo(){
    $('#detalles').load("<?php echo url("/traerDetallesSalidaMaterial"); ?>",{orden_id:$('#orden_id').val()});
  }
