...
<div class="box box-default">
  <div class="box-body table-responsive no-padding">
    <table class="table table-bordered">
      <tbody>
        <tr class="active">
          <td colspan="3"><strong><i class="fa fa-bars"></i> FORMULARIO ORDEN DE MANUFACTURA</strong></td>
        </tr>
        <tr>
          <td width="20%">
            <!-- ************************************************************************ -->
...
<script>
  ...
  function actualizar(){
    $("#vistaPrevia").show();
    $("#reporte").load('<?php echo url('/admin/PGP2_R3_REPORTE'); ?>',{
  ...
  function descargar(){
    ...
    location="<?php echo url('/admin/PGP2_R3_REPORTE_DESCARGAR'); ?>?"+parametros;
  }
</script>
@endsection