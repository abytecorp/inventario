...
<div class="header">
  <table width="100%" border="1" cellpadding="0" cellspacing="0" style="vertical-align:middle;font-weight:bold;text-align:center;">
    ...
    <tr>
      <td width="29%"><span class="Estilo3"> C&oacute;digo: PGP2 R4.4</span></td>
...
<table width="100%"  border="1" cellpadding="0" cellspacing="0" bordercolor="#999999">
  <tr bgcolor="#E5E5E5" class="Estilo6">
    <td width="10%"><div align="center"><strong>MATERIAL</strong></div></td>
    <td width="10%"><div align="center"><strong>STOCK</strong></div></td>
    ...
    <td width="10%"><div align="center"><strong>PEDIR</strong></div></td>
  </tr>
  @foreach($reporte as $qwe)
  <?php
$total = 0;
$total = $qwe->talla_xs + $qwe->talla_s + $qwe->talla_m + $qwe->talla_l + $qwe->talla_xl + $qwe->talla_xxl;
if ($total > $qwe->stock) {
    $pedir  = $total - $qwe->stock;
    $alerta = 'background:red;color:white';
} else {
    $pedir  = '';
    $alerta = '';
}
?>
  <tr class="Estilo6">
    ...
    <td><div align="center">{{$qwe->stock}}</div></td>
    ...
    <td><div align="center">{{$qwe->talla_xxl}}</div></td>
    <td><div align="center">{{$total}}</div></td>
    <td style="{{$alerta}}"><div align="center">{{$pedir}}</div></td>
  </tr>
  @endforeach
</table>
@endif
