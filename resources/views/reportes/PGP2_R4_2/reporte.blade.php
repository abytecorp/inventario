...
<div class="header">
  <table width="100%" border="1" cellpadding="0" cellspacing="0" style="vertical-align:middle;font-weight:bold;text-align:center;">
    <tr>
      ...
      <td colspan="2"><span class="Estilo5">FORMULARIO CONTROL DE INVENTARIO ENTRADAS</span></td>
      <td width="30%"><img src="logo.png" alt="Línea de Fuego" style="width:200px"></td>
    </tr>
    <tr>
      <td width="29%"><span class="Estilo3"> C&oacute;digo: PGP2 R4.2</span></td>
...
<table width="100%"  border="1" cellpadding="0" cellspacing="0" bordercolor="#999999">
  <tr bgcolor="#CCCCCC">
    <td colspan="7"><div align="center" class="Estilo6"><strong>ENTRADAS</strong></div></td>
  </tr>
  <tr bgcolor="#E5E5E5" class="Estilo6">
    <td width="11%"><div align="center"><strong>C&Oacute;DIGO</strong></div></td>
    <td width="41%"><div align="center"><strong>DESCRIPCI&Oacute;N</strong></div></td>
    <td width="6%"><div align="center"><strong>ROLLO N&deg;</strong></div></td>
    <td width="13%"><div align="center"><strong>FECHA</strong></div></td>
    <td width="12%"><div align="center"><strong>FACTURA</strong></div></td>
    <td width="9%"><div align="center"><strong>PRUEBA T&Eacute;CNICA </strong></div></td>
    <td width="8%"><div align="center"><strong>CANTIDAD (Metros/Unidad)</strong></div></td>
  </tr>
@foreach($reporte as $qwe)
  <tr class="Estilo6">
    <td><div align="center">{{$qwe->codigo}}</div></td>
    <td width="41%">{{$qwe->descripcion}}</td>
    <td width="6%"><div align="center">{{$qwe->rollo}}</div></td>
    <td width="13%"><div align="center">{{$qwe->fecha}}</div></td>
    <td width="12%"><div align="center">{{$qwe->factura}}</div></td>
    <td width="9%"><div align="center">{{$qwe->prueba_tecnica}}</div></td>
    <td width="8%"><div align="center">
      {{$qwe->cantidad_entrada}}
    </div></td>
  </tr>
@endforeach
</table>
