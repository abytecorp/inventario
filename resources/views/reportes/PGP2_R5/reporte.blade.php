...
<div class="header">
  <table width="100%" border="1" cellpadding="0" cellspacing="0" style="vertical-align:middle;font-weight:bold;text-align:center;">
    <tr>
      ...
      <td colspan="2">FORMATO SALIDA MATERIALES E INSUMOS POR ORDEN MANUFACTURA</td>
      <td width="30%"><img src="logo.png" alt="Línea de Fuego" style="width:200px"></td>
    </tr>
    <tr>
      <td width="29%"><span class="Estilo3"> C&oacute;digo: PGP2 R5</span></td>
...
<table width="100%"  border="0">
  ...
  <tr class="Estilo6">
    ...
    <td width="50%">Entrega No.: {{$rep->entrega}}</td>
  </tr>
  <tr class="Estilo6">
    <td>Fecha Entrega Mat. : {{$rep->fe_entrega}}</td>
...
<table width="100%"  border="1" cellpadding="0" cellspacing="0">
  <tr bgcolor="#E5E5E5">
    <td colspan="4"><div align="center" class="Estilo6"><strong>DATOS DE LA ORDEN</strong></div></td>
  </tr>
  <tr class="Estilo6">
    <td width="28%"><div align="center"><strong>MATERIAL</strong></div></td>
    <td width="15%"><div align="center"><strong>REF</strong></div></td>
    <td width="34%"><div align="center"><strong>LOTES</strong></div></td>
    <td width="23%"><div align="center"><strong>TOTAL</strong></div></td>
  </tr>
  <?php $separador = '';?>
  @foreach($reporte as $qwe)
  @if($separador!=$qwe->codigo)
  <?php $total = 0;
$separador     = $qwe->codigo;?>
  <tr class="Estilo6">
    <td width="28%"><div align="center">{{$qwe->tx_descripcion}}</div></td>
    <td width="15%"><div align="center">{{$qwe->codigo}}</div></td>
    <td width="34%"><div align="center">
      @foreach($reporte as $wer)
      @if($qwe->codigo==$wer->codigo)
      Lote: {{$wer->lote}} Cant.:{{$wer->cantidad}} &nbsp;&nbsp;&nbsp;&nbsp;<?php $total += $wer->cantidad;?>
      @endif
      @endforeach
    </div></td>
    <td width="23%"><div align="center">{{$total}}</div></td>
  </tr>
  @endif
  @endforeach
</table>
