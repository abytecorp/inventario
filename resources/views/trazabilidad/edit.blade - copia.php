  ...
  <div >
    ...
    @foreach($detalMatEntregadoTraza as $detalleSacado)
      @if($detalle->id==$detalleSacado->salida_orden_material_id)
        <a onclick="eliminarSalida('<?php echo $detalleSacado->salida_orden_material_id; ?>','<?php echo $detalleSacado->lote; ?>','<?php echo $detalleSacado->cantidad; ?>','<?php echo $detalleSacado->material_id; ?>')" href="#" class="label label-default btn btn-md">
