...
class AdminSalidaMaterialesOrdenDetalleFinalController extends \crocodicstudio\crudbooster\controllers\CBController {
    ...
    public function cbInit() {
        ...
        $this->col   = [];
        $this->col[] = ["label" => "Orden", "name" => "orden_id", "join" => "orden,id"];
        $this->col[] = ["label" => "Modelo", "name" => "modelo_id", "join" => "modelo,tx_modelo"];
        $this->col[] = ["label" => "Producto", "name" => "producto_terminado_id", "join" => "producto_terminado,tx_producto_terminado"];
        ...
        $this->form[] = ['label' => 'Modelo Id', 'name' => 'modelo_id', 'type' => 'select2', 'validation' => 'required|integer|min:0', 'width' => 'col-sm-10', 'datatable' => 'modelo,id'];
        $this->form[] = ['label' => 'Producto Terminado Id', 'name' => 'producto_terminado_id', 'type' => 'select2', 'validation' => 'required|integer|min:0', 'width' => 'col-sm-10', 'datatable' => 'producto_terminado,id'];
        $this->form[] = ['label' => 'Tx Talla', 'name' => 'tx_talla', 'type' => 'text', 'validation' => 'required|min:1|max:255', 'width' => 'col-sm-10'];
        $this->form[] = ['label' => 'Tx Color', 'name' => 'tx_color', 'type' => 'text', 'validation' => 'required|min:1|max:255', 'width' => 'col-sm-10'];
        $this->form[] = ['label' => 'Tx Marcaje', 'name' => 'tx_marcaje', 'type' => 'text', 'validation' => 'required|min:1|max:255', 'width' => 'col-sm-10'];
        $this->form[] = ['label' => 'Tx Reflectivo', 'name' => 'tx_reflectivo', 'type' => 'text', 'validation' => 'required|min:1|max:255', 'width' => 'col-sm-10'];
        $this->form[] = ['label' => 'Tx Detalle', 'name' => 'tx_detalle', 'type' => 'text', 'validation' => 'required|min:1|max:255', 'width' => 'col-sm-10'];
        $this->form[] = ['label' => 'Numero Vin Id', 'name' => 'numero_vin_id', 'type' => 'select2', 'validation' => 'required|integer|min:0', 'width' => 'col-sm-10', 'datatable' => 'numero_vin,id'];
        $this->form[] = ['label' => 'Tx Nombre Persona', 'name' => 'tx_nombre_persona', 'type' => 'text', 'validation' => 'required|min:1|max:255', 'width' => 'col-sm-10'];
        $this->form[] = ['label' => 'Cantidad', 'name' => 'cantidad', 'type' => 'number', 'validation' => 'required|integer|min:0', 'width' => 'col-sm-10'];
        $this->form[] = ['label' => 'Uniforme Reemp', 'name' => 'uniforme_reemp', 'type' => 'text', 'validation' => 'required|min:1|max:255', 'width' => 'col-sm-10'];
        ...
        //$this->form[] = ["label"=>"Uniforme Reemp","name"=>"uniforme_reemp","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
        # OLD END FORM
        ...
        $this->sub_module[] = ['label' => 'Sacar Material', 'path' => 'salida_materiales_orden_detalle_final_salida_orden_material', 'button_color' => 'primary', 'button_icon' => 'fa fa-bars', 'parent_columns' => 'id', 'foreign_key' => 'orden_detalle_id'];
        /*
        | ----------------------------------------------------------------------
