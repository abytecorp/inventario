...
class AdminModeloProductoController extends \crocodicstudio\crudbooster\controllers\CBController {
    ...
    public function cbInit() {
        ...
        $this->form[] = ['label' => 'Normativo', 'name' => 'tx_normativo', 'type' => 'text', 'validation' => 'required|min:1|max:255', 'width' => 'col-sm-10'];
        ...
        $this->form[] = ['label' => 'Color', 'name' => 'tx_color', 'type' => 'text', 'validation' => 'required|min:1|max:255', 'width' => 'col-sm-10'];
        ...
        //$this->form[] = ["label"=>"Tx Normativo","name"=>"tx_normativo","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
        ...
        $this->sub_module[] = ['label' => 'Detalles', 'path' => 'detalle_modelo_materia', 'parent_columns' => 'tx_color,tx_talla', 'foreign_key' => 'modelo_material_id', 'button_color' => 'success', 'button_icon' => 'fa fa-bars'];
