...
class AdminOrdenReparacionController extends \crocodicstudio\crudbooster\controllers\CBController {
    ...
    public function cbInit() {
        ...
        $this->table               = "orden_reparacion";
        # END CONFIGURATION DO NOT REMOVE THIS LINE

        # START COLUMNS DO NOT REMOVE THIS LINE
        $this->col   = [];
        $this->col[] = ["label" => "N°", "name" => "id"];
        $this->col[] = ["label" => "Orden Manufactura", "name" => "orden_id", "join" => "orden,id"];
        ...
        $this->form     = [];
        $this->form[]   = ['label' => 'Orden Manufactura', 'name' => 'orden_id', 'type' => 'select2', 'validation' => 'required|integer|min:0', 'width' => 'col-sm-10', 'datatable' => 'orden,id'];
        ...
        $this->form[]   = ['label' => 'Guia Correo Entrada', 'name' => 'guia_correo_ent', 'type' => 'text', 'validation' => 'required|min:1|max:255', 'width' => 'col-sm-10'];
        $this->form[]   = ['label' => 'Garantia Entrada', 'name' => 'id_garantia_ent', 'type' => 'select2', 'validation' => 'required|integer|min:0', 'width' => 'col-sm-10', 'datatable' => 'garantia,nombre'];
        ...
        $this->form[]   = ['label' => 'Aprobador', 'name' => 'id_aprobador', 'type' => 'select2', 'validation' => 'required|integer|min:0', 'width' => 'col-sm-10', 'datatable' => 'cms_users,name'];
        ...
        $this->form[]   = ['label' => 'Garantia Sal', 'name' => 'id_garantia_sal', 'type' => 'select2', 'validation' => 'required|integer|min:0', 'width' => 'col-sm-10', 'datatable' => 'garantia,nombre'];
        $this->form[]   = ['label' => 'Guia Correo Sal', 'name' => 'guia_correo_sal', 'type' => 'text', 'validation' => 'required|min:1|max:255', 'width' => 'col-sm-10'];
        $this->form[]   = ['label' => 'Comentario Sal', 'name' => 'comentario_sal', 'type' => 'textarea', 'validation' => 'required|string|min:5|max:5000', 'width' => 'col-sm-10'];
        $this->form[]   = ['label' => 'Fecha Reparacion', 'name' => 'fecha_reparacion', 'type' => 'date', 'validation' => 'required|date', 'width' => 'col-sm-10'];
        ...
        $this->sub_module[] = ['label' => 'Detalles', 'path' => 'detalle_reparacion', 'parent_columns' => 'orden_id,fecha_llegada', 'foreign_key' => 'orden_reparacion_id', 'button_color' => 'success', 'button_icon' => 'fa fa-bars'];
